...
void Player::UpdateHonorFields()
{
    ...
    if (sWorld.getConfig(CONFIG_BOOL_ALLOW_HONOR_KILLS_TITLES))
    {
        ...
        if (HonorKills >= 25 && HonorKills < 100)
            victim_rank = 1;
            ...
            victim_rank = 5;
        else if (HonorKills >= 1500 && HonorKills < 3000)
            victim_rank = 6;
            ...
            victim_rank = 11;
        else if (HonorKills >= 25000 && HonorKills < 45000)
            victim_rank = 12;
        else if (HonorKills >= 45000 && HonorKills < 60000)
            victim_rank = 13;
